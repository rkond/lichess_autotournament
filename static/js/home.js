...
function TemplateEditor(props) {
  ...
  return e('div', {
    ...
    e(TournamentSelectField, {
      ...
      options: [
        { 'value': 0, 'text': 'no min rating' },
        { 'value': 1000, 'text': 'min rating of 1000' },
        { 'value': 1100, 'text': 'min rating of 1100' },
        { 'value': 1200, 'text': 'min rating of 1200' },
        { 'value': 1300, 'text': 'min rating of 1300' },
        { 'value': 1400, 'text': 'min rating of 1400' },
        { 'value': 1500, 'text': 'min rating of 1500' },
        { 'value': 1600, 'text': 'min rating of 1600' },
        { 'value': 1700, 'text': 'min rating of 1700' },
        { 'value': 1800, 'text': 'min rating of 1800' },
        { 'value': 1900, 'text': 'min rating of 1900' },
        { 'value': 2000, 'text': 'min rating of 2000' },
        { 'value': 2100, 'text': 'min rating of 2100' },
        { 'value': 2200, 'text': 'min rating of 2200' },
        { 'value': 2300, 'text': 'min rating of 2300' },
        { 'value': 2400, 'text': 'min rating of 2400' },
        { 'value': 2500, 'text': 'min rating of 2500' },
        { 'value': 2600, 'text': 'min rating of 2600' }],
    ...
    e(TournamentSelectField, {
      ...
      options: [
        { 'value': 0, 'text': 'no max rating' },
        { 'value': 800, 'text': 'max rating of 800' },
        { 'value': 900, 'text': 'max rating of 900' },
        { 'value': 1000, 'text': 'max rating of 1000' },
        { 'value': 1100, 'text': 'max rating of 1100' },
        { 'value': 1200, 'text': 'max rating of 1200' },
        { 'value': 1300, 'text': 'max rating of 1300' },
        { 'value': 1400, 'text': 'max rating of 1400' },
        { 'value': 1500, 'text': 'max rating of 1500' },
        { 'value': 1600, 'text': 'max rating of 1600' },
        { 'value': 1700, 'text': 'max rating of 1700' },
        { 'value': 1800, 'text': 'max rating of 1800' },
        { 'value': 1900, 'text': 'max rating of 1900' },
        { 'value': 2000, 'text': 'max rating of 2000' },
        { 'value': 2100, 'text': 'max rating of 2100' },
        { 'value': 2200, 'text': 'max rating of 2200' }],
